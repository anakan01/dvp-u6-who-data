...
#Chili, China, USA, Zimbabwe, Germany, Mexico
...
plt.title("Life Expectancy At Birth Year Violinplot by Country")
plt.show()
...
df_s = df[(df.Country == 'Zimbabwe')]
f, ax1 = plt.subplots(figsize=(10, 8)) 
ax1=sns.barplot(x="Country",y="GDP", hue="Year",data=df_s)
plt.ylabel("GDP in Tens of billions of U.S. Dollars")
plt.show()
f, ax2 = plt.subplots(figsize=(10, 8)) 
ax2=sns.barplot(x="Country",y="GDP", hue="Year",data=df[(df.Country != 'Zimbabwe')])
...
#Zimbabwe's LEABY changed the most
#China, Germany, and USA have disparingly larger GDP's than Chile, Mexico, and Zimbabwe. Zimbabwe has a different YEABY than others
#Zimbabwe's life expectancy changes with GDP, due to overall QOL improvements that come with increased GDP in a developing country
...
# Uncomment the code below and fill in the blanks
g3 = sns.FacetGrid(df, col="Country", col_wrap=6, height=6)
...
#USA has the highest GDP
#Zimbabwe has the lowest GDP
...
#Germany has highest LEABY
#Zimbabwe has lowest LEABY
...
#China's industrial and high-tech sectors have increased in terms of size and output.
